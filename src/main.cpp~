...
uint256 hashGenesisBlock("0x5b3872aae54d4ebedcbfee78fcddceba6b4f71a83be2c88f20f1651e2208a2f8");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Electric: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Electric Signed Message:\n";
...
static const int64 nTargetTimespan = 4 * 60 * 60; // Electric: every 4 hours
static const int64 nTargetSpacing = 60; // Electric: 1 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // Electric: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Electric miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Electric", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe12ab169c7b95ffbdc6ed2a6250710357f67c6d72317459e684cec72bc823a65");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Electric: Brought to you by Thomas Edison";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388659863;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1552826;


        if (fTestNet)
        {
            block.nTime    = 1388654170;
            block.nNonce   = 1310173;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xaf656abe167f34bc2613b4317fcdc4fd0e6db52899574acaff90f1e30925d7c3"));
...
unsigned char pchMessageStart[4] = { 0x17, 0x07, 0xa4, 0xe6 }; 
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Electricd: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
